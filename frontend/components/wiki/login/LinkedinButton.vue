<template>
  <a
    ...
    id="linkedin"
    :class="{
      'linkedin-button': true,
      '--hover': linkedin_btn.hover,
      '--pre-hover': prehvr,
    }"
    @mouseover="linkedin_btn.hover ? (prehvr = false) : (prehvr = true)"
...
export default {
  ...
  methods: {
    linkedin_button_handle() {
      this.$set(this.linkedin_btn, "focus", true);
      this.$emit("click");
    },
  },
};
